...
def data_to_html():
    ...
    return render_template("dataframe.html", data=dataframe.to_html(index=True).replace('<table border="1" class="dataframe">', '<table id="dataframe" class="table table-hover" style="font-size:13px;">'))
